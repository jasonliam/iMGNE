...
class TSM(object):
    ...
    def run(self, reader, writer=None, flush=True, 
            stft_fname=None, stft_only=True, verbose=False): # duys
        ...
        while not (finished and reader.empty):
            #print(reader._reader.tell(), reader._reader.getnframes())
        ...
        # duys
        if stft_fname is not None:   
            self.write_stft_to_file(stft_fname, verbose)
    ...
    def write_stft_to_file(self, fname, verbose=False):
        """ duys
        """
        pass